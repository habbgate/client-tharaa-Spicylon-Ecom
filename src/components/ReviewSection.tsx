    ...
    <div className="mt-32">
      ...
      {showForm && (
        <form
          ...
          className="bg-stone-50 rounded-3xl p-8 mb-12 border border-stone-200"
        >
      ...
      {reviews.length === 0 ? (
        <div className="bg-stone-50 rounded-3xl p-12 text-center border-2 border-dashed border-stone-200">
          ...
          {!showForm && (
            <button
              onClick={() => setShowForm(true)}
              className="px-8 py-3 bg-stone-900 text-white font-bold rounded-xl hover:bg-stone-800"
            >
              {t("writeReview")}
            </button>
          )}
        ...
        <div className="space-y-6">
          {paginatedReviews.map((review: any, index: number) => (
            <div
              ...
              className="bg-white p-6 rounded-3xl border border-stone-200 flex flex-col sm:flex-row gap-6"
            >
